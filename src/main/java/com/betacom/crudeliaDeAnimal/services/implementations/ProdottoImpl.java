...
public class ProdottoImpl implements IProdottoServices {
    ...
    @Override
    public void create(ProdottoReq req) throws CrudeliaException {
    ...
    @Override
    public void update(ProdottoReq req) throws CrudeliaException {
    ...
    @Override
    public ProdottoDTO delete(ProdottoReq req) throws CrudeliaException {
        Optional<Prodotto> p = IProR.findById(req.getId());
        if(p.isEmpty())
   			throw new CrudeliaException(msgS.getMessaggio("PRODUCT_NOT_FOUND"));
        IProR.delete(p.get());
